...
if GetLocale() == "ruRU" then
    ...
    QH_HEALING_BAR = "Лечащая полоса:";
    QH_DISPLAY_HEALING_BAR = "Показать лечащую полосу";
...
L:RegisterTranslations("ruRU", function() return {
    ...
    ["Healing (Green)"] = "Лечение (Зеленый)",         -- Значения переменных типа Blacklist не менялись
